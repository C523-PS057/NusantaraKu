...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="col-lg-8">
      ...
      <form method="POST" action="{{ route('rumah.update',$data->id) }}" class="mb-5" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-3">
          <label for="rumah_adat_name" class="form-label">Rumah Adat Name</label>
          <input type="text" class="form-control" id="rumah_adat_name" name="rumah_adat_name" autofocus value="{{ old('rumah_adat_name',$data->rumah_adat_name) }}">
        ...
        <button type="submit" class="btn btn-warning">Update Pakaian</button>
      </form>
  </div>
  <script>
