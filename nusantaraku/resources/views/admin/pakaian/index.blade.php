...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="input-group mb-3">
    ...
    <a href="{{ route('pakaian.create') }}" class="btn btn-primary mb-3">Create New Pakaian</a>
    <div class="card-dis">
  ...
  @else
    <div class="d-flex justify-content-center my-2">
        <div class=""><h2>No Pakaian Found</h2></div>
    </div>
    <div class="d-flex justify-content-center my-1">
        <div class=""><a href="{{ route('pakaian.create') }}" class="btn btn-primary">Create New Pakaian</a></div>
    </div>
@endif
@endsection
