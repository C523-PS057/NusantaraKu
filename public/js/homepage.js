...
const setTestimonial = (index) => {
    document.querySelector(".testimonial__name").textContent =
        testimonial[index].name;
    document.querySelector(".testimonial__job").textContent =
        testimonial[index].job;
    document.querySelector(".testimonial__text").textContent =
