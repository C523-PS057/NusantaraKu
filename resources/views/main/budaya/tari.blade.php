                    ...
                    <div class="row">
                        <div class="col-md-8 mx-auto detail__column">
                            ...
                            <div class="detail__content">
                                ...
                                <div class="detail__section">
                                    ...
                                    <div class="detail__comment">
                                        ...
                                        <div class="detail__comment-item my-2">
                                            ...
                                            @can('admin')
                                            <form class="detail__comment-action" method="POST" action="{{ route('detail-tari.destroy',$item->id) }}">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <form method="POST" class="comment__form" action="{{ route('detail-tari.store') }}">
                                    @csrf
                                    <input type="hidden" name="user_id" value="{{ auth()->user()->id }}">
                                    <input type="hidden" name="budaya_id"value="{{ $data->budaya_id }}">
                                    <input type="hidden" name="tari_id"value="{{ $data->id }}">
