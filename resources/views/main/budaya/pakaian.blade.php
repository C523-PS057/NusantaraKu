...
<head>
    ...
    <title>{{ ucfirst($data->pakaian_name) }} - NusantaraKu</title>
                ...
                <div class="row">
                    <div class="col-md-8 mx-auto detail__column">
                        <div class="detail__header">
                            <span class="headline text-primary">PAKAIAN ADAT</span>
                            <h1>{{ ucfirst($data->pakaian_name) }}</h1>
                        </div>
                                ...
                                <div class="detail__comment">
                                    ...
                                    <div class="detail__comment-item">
                                        ...
                                        <form class="detail__comment-action" method="POST"
                                            action="{{ route('detail-pakaian.destroy',$item->id) }}">
                                            @csrf
                                            @method('DELETE')
