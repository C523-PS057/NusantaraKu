...
<html lang="en">
    <head>
        ...
        <title>Pakaian Adat - NusantaraKu</title>
            ...
            <div class="categories">
                <div class="container">
                    <div class="categories__filter">
                            <form class="categories__filter-search" action="{{ route('pakaian-adat.index') }}" method="GET">
                        ...
                        <div class="categories__filter-group group-2">
                            <form action="{{ route('pakaian-adat.index') }}" method="GET" id="filterForm">
                            ...
                            <form action="{{ route('pakaian-adat.index') }}" method="GET" id="filterUrutkan">
                            ...
                            <div class="col-6 col-md-3">
                                <a href="/detail-pakaian/{{ $item->id }}" class="detail__item">
                                    ...
                                    <div class="detail__item-content">
                                        <h6>Pakaian Adat {{ $item->pakaian_name }}</h6>
