...
<html lang="en">
    <head>
        ...
        <title>Masakan Khas - NusantaraKu</title>
            ...
            <div class="categories">
                <div class="container">
                    <div class="categories__filter">
                            <form class="categories__filter-search" action="{{ route('masakan-khas.index') }}" method="GET">
                        ...
                        <div class="categories__filter-group group-2">
                            <form action="{{ route('masakan-khas.index') }}" method="GET" id="filterForm">
