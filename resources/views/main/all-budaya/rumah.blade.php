...
<html lang="en">
    <head>
        ...
        <title>Rumah Adat - NusantaraKu</title>
    ...
    <body>
        ...
        <main>
            <div class="banner-category" style="background-image: url('../img/bg-rumah-adat.webp')">
                <div class="banner-category__content">
                    <h2>Rumah Adat</h2>
                    <p><strong>Rumah Adat</strong> yang dilestarikan turun temurun hingga saat ini</p>
                </div>
            </div>
            <div class="categories">
                <div class="container">
                    <div class="categories__filter">
                            <form class="categories__filter-search" action="{{ route('rumah-adat.index') }}" method="GET">
                        ...
                        <div class="categories__filter-group group-2">
                            <form action="{{ route('rumah-adat.index') }}" method="GET" id="filterForm">
                            ...
                            <div class="col-6 col-md-3">
                                <a href="/detail-rumah/{{ $item->id }}" class="detail__item">
                                    <div class="detail__item-image">
                                        <img src="{{ Storage::url($item->gambar) }}" alt="Rumah Adat Image" />
                                    ...
                                    <div class="detail__item-content">
                                        <h6>Rumah Adat {{ $item->rumah_adat_name }}</h6>
