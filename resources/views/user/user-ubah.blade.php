                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 mx-auto user__col">
                            ...
                            <form class="user__content" method="POST" action="{{ route('change-password.update',$data->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="user__detail">
                                    <div class="input__group">
                                        <label class="input__label" for="old-password">Password Lama</label>
                                        <input type="password" value="{{ old('password') }}" name="oldPassword" id="old-password" required autocomplete="true" />
                                    ...
                                    <div class="input__group">
                                        ...
                                        <input type="password" name="password" id="new-password" required autocomplete="true" />
                                        <button class="btn-icon btn-toggle-password"><i class="ri-eye-line"></i></button>
                                        @error('password')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="input__group">
                                        <label class="input__label" for="confirm-new-password">Konfirmasi Password Baru</label>
                                        <input type="password" name="password_confirmation" id="confirm-new-password" required autocomplete="true" />
                                        <button class="btn-icon btn-toggle-password"><i class="ri-eye-line"></i></button>
