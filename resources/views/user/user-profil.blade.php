                    ...
                    <div class="col-md-4 mx-auto user__col">
                        ...
                        <div class="user__content">
                            ...
                            <div class="user__detail">
                                <h5 class="user__fullname">{{ $data->name }}
                                    @if ($data->role == 'admin')
                            ...
                            <div class="user__buttons">
                                ...
                                <a href="{{ route('user-settings.edit',$data->id) }}" class="btn btn-primary">Edit
                                    Profil <i class="ri-edit-line"></i></a>
                                <a href="{{ route('change-password.edit',$data->id) }}" class="btn btn-outline">Ubah
                                    Password <i class="ri-key-2-line"></i></a>
                                @else
                                <a href="{{ route('user-settings.edit',$data->id) }}" class="btn btn-primary">Edit
                                    Profil <i class="ri-edit-line"></i></a>
                                @endif
