...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Alat Musik Khas</h1>
  </div>
  ...
  <div class="input-group mb-3">
    ...
    <a href="{{ route('musik.create') }}" class="btn btn-primary mb-3">Create new Alat Musik</a>
    <div class="card-dis">
  ...
  @else
    <div class="d-flex justify-content-center my-2">
        <div class=""><h2>No Alat Musik Found</h2></div>
    </div>
    <div class="d-flex justify-content-center my-1">
        <div class=""><a href="{{ route('musik.create') }}" class="btn btn-primary">Create New Alat Musik</a></div>
    </div>
@endif
@endsection
