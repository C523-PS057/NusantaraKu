                                ...
                                <div class="detail__item-content">
                                    ...
                                    <div class="detail__item-buttons">
                                      ...
                                      <form action="{{ route('musik.destroy',$item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-primary" style="width: 100%" onclick="return confirm('Yakin hapus data alat musik ini?')"><i class="ri-delete-bin-line"></i> Hapus</button>
                                    </form>
                                    </div>
                                </div>
                            </div>
