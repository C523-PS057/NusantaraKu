...
<form action="{{ route('rumah.index') }}" method="GET">
    <div class="input-group mb-3 dashboard__search">
        <div class="col-md-5">
            <input name="search" type="text" class="form-control" placeholder="Cari Rumah Adat.." aria-label="search"
            ...
            <div class="detail__item">
                ...
                <div class="detail__item-content">
                    ...
                    <div class="detail__item-buttons">
                        <a href="/detail-rumah/{{ $item->id }}" class="btn btn-outline" target="_blank"
                            rel="noopener noreferrer"><i class="ri-eye-line"></i> Lihat</a>
                        <a href="{{ route('rumah.edit',$item->id) }}" class="btn btn-outline"><i
                                class="ri-edit-line"></i>Ubah</a>
                        <form action="{{ route('rumah.destroy',$item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-primary" style="width: 100%"
                                onclick="return confirm('Yakin hapus data rumah adat ini?')"><i
...
<div class="d-flex justify-content-center my-2">
    <div class="">
        <h2>Tidak ada Rumah Adat yang ditemukan</h2>
    </div>
</div>
