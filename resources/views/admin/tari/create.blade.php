...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah Data Tari Tradisional</h1>
  </div>
  <div class="col-lg-8">

      <form method="POST" action="{{ route('tari.store') }}" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
          <label for="tarian_name" class="form-label">Nama Tari Tradisional</label>
          <input type="text" class="form-control" id="tarian_name" name="tarian_name" autofocus value="{{ old('tarian_name') }}">
          @error('tarian_name')
