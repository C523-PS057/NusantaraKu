...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah Data Provinsi</h1>
</div>
<div class="col-lg-8">

    <form method="POST" action="{{ route('province.store') }}" class="mb-5">
        @csrf
        <div class="mb-3">
            <label for="province_name" class="form-label">Nama Provinsi</label>
            <input type="text" class="form-control" id="province_name" name="province_name" autofocus
